...
public class InsertAdContainerFragment extends BaseFragment {
  ...
  private void showInsertAdFragment() {
    if (getChildFragmentManager().findFragmentByTag("InsertAdContainerFragment") != null) {
      insertAdFragment = getChildFragmentManager().findFragmentByTag("InsertAdContainerFragment");
    } else {
      insertAdFragment = new InsertAdFragment();
      FragmentTransaction transaction = getChildFragmentManager().beginTransaction();
      transaction.replace(R.id.ll_insert_ad_container, insertAdFragment, InsertAdFragment.TAG);
  ...
  private void showSplashFragment() {
    if (getChildFragmentManager().findFragmentByTag("SplashFragment") != null) {
      ...
      FragmentTransaction transaction = getChildFragmentManager().beginTransaction();
      transaction.replace(R.id.ll_insert_ad_container, splashFragment, SplashFragment.TAG);
      transaction.addToBackStack(null);
      transaction.commit();
    }
  }
